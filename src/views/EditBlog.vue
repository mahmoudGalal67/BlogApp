...
export default {
        ...
        if (this.file) {
          ...
          uploadTask.on(
            ...
            async () => {
              ...
              const blog = await setDoc(
                doc(db, "blogPosts", this.$route.params.id),
                {
                  blogDesc: this.desc,
              ...
              this.$store.commit("updateBlog", updateBlog);
              this.newBlog = blog;
              this.loading = false;
              this.$router.push({
                name: "ViewBlog",
  ...
  async mounted() {
    ...
    const result = await getDoc(doc(db, "blogPosts", this.$route.params.id));
    this.currentBlog = result.data();
    this.title = this.currentBlog.blogTitle;
    this.fileName = this.currentBlog.blogCoverPhotoName;
    this.desc = this.currentBlog.blogDesc;
  },
};
</script>
